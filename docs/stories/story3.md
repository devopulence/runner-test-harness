...
h1. Task 3: Collect Workflow Run Data via GitHub API
...
# {{src/monitoring/collect_workflow_runs.py}} - Collector implementation with CLI
# {{src/monitoring/test_collect_workflow_runs.py}} - 18 unit tests covering all functionality
...
h2. Live Test Results (2026-03-16)

h3. Single Repo Test — {{devopulence/pythonProject}}
...
h3. Deduplication Test — Second Run
...
h2. Downstream Tasks That Depend on This
